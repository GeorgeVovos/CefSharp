...
param(
    ...
    [string] $Version = "139.0.380",
    [Parameter(Position = 2)]
    [string] $AssemblyVersion = "139.0.380",
...
function Nupkg
{
    ...
    foreach($file in $Files)
    {
        ...
        try
        {
            # We need to rewrite the BTL.CefSharp.Common nupkg file if we are building a subset of architectures
